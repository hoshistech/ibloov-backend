...
module.exports = {
    ...
    all: async( query, options) => {
        ...
        .populate('userId', '_id avatar authMethod local.firstName local.lastName google fullName phoneNumber')
        .populate('contacts.userId', '_id avatar authMethod local.firstName local.lastName google fullName phoneNumber')
        .sort(sort)
        .limit(limit)
        .skip(skip);
