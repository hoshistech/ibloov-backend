...
module.exports = {
    ...
    all: async( query, options) => {
        ...
        .populate('userId', '_id avatar authMethod local.firstName local.lastName fullName google phoneNumber')
        .populate('contacts.userId', '_id avatar authMethod local.firstName local.lastName fullName google phoneNumber')
        .sort(sort)
        .limit(limit)
        .skip(skip);
