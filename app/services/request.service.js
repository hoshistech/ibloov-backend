...
module.exports = {
    ...
    viewRequestById: async( requestId ) => {
        ...
        .populate("requesteeId", "_id avatar authMethod local.firstName local.lastName google facebook apple fullName")
        .populate("accepteeId", "_id avatar authMethod local.firstName local.lastName google facebook apple fullName");
    },
